...
def calculateSlAndStoreSignal(signal, strategy, jsonSignal, session):
    ...
    if signalStats is not None and signalStats.alltrades > 110:
...
def proceedSignal(signal):
    ...
    with Session.begin() as session:
        ...
        if strategy == "T3-HalfTrend" or strategy == "T3-BernoulliEntropyFunction" or strategy == "T3-DiCrossingDaily" or strategy == "T3-MacdScalp" or strategy == "T3-VolumeDifferenceDeltaCycleOscillator" or strategy == "NNR" or strategy == "T3-LocallyWeightedRegression" or strategy == "T3-HmaKahlman" or strategy == "T3-EvwmaVwapMacd" or strategy == "T3-EfficientTrendStepMod" or strategy == "SOTT-Lorentzian" or strategy == "T3-Eams" or strategy == "T3-SupportAndResistanceLevels" or strategy == "T3-MesaPhasor" or strategy == "T3-BollingerBandsPinbar" or strategy == "T3-NNFX" or strategy == "VHMA" or strategy == "RSS_WMA" or strategy == "Super AI Trend" or strategy == "SSL Hybrid" or strategy == "SentimentRangeMa" or strategy == "T3-EmaStrategy" or strategy == "T3-AroonBased" or strategy == "T3Fvma" or strategy == "T3-JMaCrossover" or strategy == "T3-GapFilling":
