...
if __name__ == '__main__':
    ...
    data = loadDfFromDb("EURUSD", TimeFrame.PERIOD_H4)
    #data['date'] = data['DATETIME'].astype('datetime64[s]')
    ...
    print("##########SUPPORT#############")
    print("First row: ", data['support_slope'].iloc[0])
    print("Last row:  ", data['support_slope'].iloc[-1])
    print("")
    print("##########RESISTANCE#############")
    print("First row: ", data['resist_slope'].iloc[0])
    print("Last row:  ", data['resist_slope'].iloc[-1])
